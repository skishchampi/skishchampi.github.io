...
description: "Publications by Aakash Solanki: public scholarship, interdisciplinary scholarly output, peer-reviewed articles, and book chapters."
---
...
<header class="pagehead">
  <div>
    ...
    <h1>Writings.</h1>
    <p class="standfirst">Public scholarship, interdisciplinary work, and peer-reviewed pieces. Full texts linked where open-access; otherwise please write for a copy.</p>
  </div>
  <div class="meta">
    <dl>
